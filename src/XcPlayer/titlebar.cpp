    ...
    QWidget(parent)
{
    ...
    TiBar_pMinimizeBtn  = new QToolButton;
    TiBar_pMaximizeBtn  = new QToolButton;
    TiBar_pCloseBtn     = new QToolButton;
...
{
    QToolButton *pBtn = qobject_cast<QToolButton *>(sender());//如果在由信号激活的槽中调用，则返回指向发送信号的对象的指针; 否则它返回0.
